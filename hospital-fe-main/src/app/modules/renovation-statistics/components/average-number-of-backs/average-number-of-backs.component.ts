...
@Component({
  selector: 'app-average-number-of-backs',
  templateUrl: './average-number-of-backs.component.html',
  styleUrls: ['./average-number-of-backs.component.css']
})
export class AverageNumberOfBacksComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.importData.subscribe({
      ...
      d3.select("#my_dataviz3").selectChildren().remove();
