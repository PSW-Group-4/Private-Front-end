...
@Component({
  selector: 'app-steps-on-session-per-age-group',
  templateUrl: './steps-on-session-per-age-group.component.html',
  styleUrls: ['./steps-on-session-per-age-group.component.css'],
})
export class StepsOnSessionPerAgeGroupComponent implements OnInit {
  public chart: any;
  @Input() chartData: any;
  ...
  createChart() {
    ...
    this.chart = new Chart('MyChartStepAgeGroup', {
